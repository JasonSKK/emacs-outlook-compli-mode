-- "Exporting emails from Outlook with AppleScript" original script by Moth Software, retrieved on May 1st, 2023, from the Moth Software Blog
-- Author: Beatrix Willius
-- https://www.mothsoftware.com/exporting-emails-from-outlook-with-applescript
...
tell application "Microsoft Outlook"
    ...
    set theFolder to (choose folder with prompt "Select a folder to save the exported files")
    ...
    repeat with theMessage in selectedMessages
        ...
        --use file on DIRECTORY
        --set this_file to ((path to home as text) & "outlook-mail:" & theSubject & ".eml")
        set this_file to ((theFolder as text) & theSubject & ".eml")
